...
from xrd.daemon.helper.DaemonHelper import WalletDecryptionError
from xrd.core.misc import logger
from tests.misc.helper import set_xrd_dir, get_alice_xmss, get_bob_xmss
...
class TestWalletD(TestCase):
    ...
    def test_get_unused_ots_index(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetOTS = Mock(
                return_value=xrd_pb2.GetOTSResp(next_unused_ots_index=10, unused_ots_index_found=True))
            ...
            walletd._public_stub.GetOTS = Mock(
                return_value=xrd_pb2.GetOTSResp(next_unused_ots_index=10, unused_ots_index_found=False))
    ...
    def test_sign_and_push_transaction(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd._public_stub.PushTransaction = Mock(
                return_value=xrd_pb2.PushTransactionResp(error_code=xrd_pb2.PushTransactionResp.UNKNOWN))
    ...
    def test_relay_message_txn(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            tx = walletd.relay_message_txn(message='Hello xrd!',
                                           fee=100000000,
                                           master_qaddress=None,
                                           signer_address=qaddress,
                                           ots_index=0)
    ...
    def test_relay_message_txn_by_slave(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            tx = walletd.relay_message_txn_by_slave(message='Hello xrd!',
                                                    fee=100000000,
                                                    master_qaddress=qaddress)
            self.assertIsNotNone(tx)
    ...
    def test_relay_message_txn2(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_message_txn(message='Hello xrd!',
                                          fee=100000000,
                                          master_qaddress=None,
                                          signer_address=qaddress,
                                          ots_index=0)
    ...
    def test_relay_message_txn2_by_slave(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_message_txn_by_slave(message='Hello xrd!',
                                                   fee=100000000,
                                                   master_qaddress=qaddress)
    ...
    def test_relay_token_txn(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            tx = walletd.relay_token_txn(symbol='xrd',
    ...
    def test_relay_token_txn_by_slave(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            tx = walletd.relay_token_txn_by_slave(symbol='xrd',
                                                  name='Quantum Resistant Ledger',
                                                  owner_qaddress=alice_xmss.qaddress,
                                                  decimals=5,
                                                  qaddresses=qaddresses,
    ...
    def test_relay_token_txn2(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_token_txn(symbol='xrd',
                                        name='Quantum Resistant Ledger',
                                        owner_qaddress=alice_xmss.qaddress,
                                        decimals=5,
                                        qaddresses=qaddresses,
    ...
    def test_relay_token_txn2_by_slave(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_token_txn_by_slave(symbol='xrd',
                                                 name='Quantum Resistant Ledger',
                                                 owner_qaddress=alice_xmss.qaddress,
                                                 decimals=5,
                                                 qaddresses=qaddresses,
    ...
    def test_get_transaction(self):
        with set_xrd_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTransaction = Mock(
                return_value=xrd_pb2.GetTransactionResp(tx=tx,
                                                        confirmations=10,
                                                        block_number=5,
