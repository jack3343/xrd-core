...
from tests.misc.helper import get_alice_xmss, get_slave_xmss, get_random_xmss, set_xrd_dir
...
class TestAddressState(TestCase):
    ...
    @patch('xrd.core.AddressState.AddressState.transaction_hashes', new_callable=PropertyMock)
