...
from xrd.crypto.misc import sha256
...
@patch('xrd.core.p2p.p2pChainManager.logger')
class TestP2PChainManager(TestCase):
    ...
    def test_handle_fetch_block(self, m_logger):
        ...
        self.channel.factory.get_block_by_number.return_value = Mock(autospec=Block, pbdata=xrd_pb2.Block())
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.FB, fbData=xrdlegacy_pb2.FBData(index=1))
    ...
    def test_handle_fetch_block_bad_height(self, m_logger):
        ...
        """
        self.channel.factory.chain_height = 10
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.FB, fbData=xrdlegacy_pb2.FBData(index=100))
        self.manager.handle_fetch_block(self.channel, msg)
    ...
    def test_handle_push_block(self, m_logger):
        ...
        :return:
        """
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.PB, pbData=xrdlegacy_pb2.PBData(block=xrd_pb2.Block()))
        self.manager.handle_push_block(self.channel, msg)

        self.channel.factory.block_received.assert_called()

    @patch('xrd.core.p2p.p2pChainManager.Block')
    def test_handle_push_block_bad_block(self, m_Block, m_logger):
        ...
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.PB)
        self.manager.handle_push_block(self.channel, msg)
    ...
    def test_handle_block_height_incoming_request(self, m_logger):
        ...
        incoming_request = make_message(func_name=xrdlegacy_pb2.LegacyMessage.BH,
    ...
    def test_handle_block_height_incoming_information(self, m_logger):
        ...
        incoming_info = make_message(func_name=xrdlegacy_pb2.LegacyMessage.BH,
                                     bhData=xrd_pb2.BlockHeightData(
                                         block_number=1,
    ...
    def test_handle_node_headerhash_peer_has_no_headerhashes(self, m_logger):
        ...
        """
        self.channel.factory.get_headerhashes.return_value = xrd_pb2.NodeHeaderHash()
        incoming_request = make_message(func_name=xrdlegacy_pb2.LegacyMessage.HEADERHASHES,
                                        nodeHeaderHash=xrd_pb2.NodeHeaderHash(block_number=0)
                                        )
    ...
    def test_handle_node_headerhash_peer_has_headerhashes(self, m_logger):
        ...
        """
        incoming_info = make_message(func_name=xrdlegacy_pb2.LegacyMessage.HEADERHASHES,
                                     nodeHeaderHash=xrd_pb2.NodeHeaderHash(block_number=3,
