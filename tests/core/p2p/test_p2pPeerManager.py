...
from tests.misc.helper import set_xrd_dir
...
def make_node_chain_state():
    node_chain_state = xrd_pb2.NodeChainState(block_number=0,
                                              header_hash=b'',
...
class TestP2PPeerManager(TestCase):
    ...
    @patch('xrd.core.p2p.p2pPeerManager.logger', autospec=True)
    def test_load_peer_addresses_corrupt_file(self, logger):
        """
        If peers.xrd is corrupt, load_peer_addresses should rewrite it with valid peers from config.user.peer_list
        """
        with set_xrd_dir('peers') as tmp_dir:
    ...
    def test_update_peer_addresses_also_connects_to_new_peers(self, logger):
        ...
        with set_xrd_dir('no_data') as tempdir:
    ...
    def test_handle_version(self):
        ...
        message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.VE,
    ...
    def test_handle_version_empty_version_message(self):
        ...
        message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.VE,
                                              veData=xrdlegacy_pb2.VEData(version='',
                                                                          genesis_prev_hash=config.user.genesis_prev_headerhash,
                                                                          rate_limit=config.user.peer_rate_limit))
        self.peer_manager.handle_version(channel, message)
    ...
    def test_handle_peer_list_empty_peer_list_message(self, logger):
        ...
        """
        peer_list_message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.PL,
                                                        plData=xrdlegacy_pb2.PLData(peer_ips={}, public_port=9000))
        channel = make_channel()
    ...
    @patch('xrd.core.p2p.p2pPeerManager.logger', autospec=True)
    @patch('xrd.core.p2p.p2pPeerManager.config', autospec=True)
    ...
    def test_handle_sync(self):
        ...
        """
        sync_message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=xrdlegacy_pb2.SYNCData(state='Synced'))
        channel = make_channel()
    ...
    def test_handle_sync_unsynced(self):
        ...
        """
        sync_message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=xrdlegacy_pb2.SYNCData(state='Unsynced'))
        channel = make_channel()
    ...
    def test_handle_sync_blank(self):
        ...
        """
        sync_message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=xrdlegacy_pb2.SYNCData(state=''))
        channel = make_channel()
    ...
    def test_handle_chain_state_works(self):
        ...
        chain_state_message = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.CHAINSTATE,
    ...
    def test_handle_p2p_acknowledgement(self):
        ...
        """
        ack = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.P2P_ACK,
                                          p2pAckData=xrd_pb2.P2PAcknowledgement(bytes_processed=15))
        channel = make_channel()
    ...
    def test_handle_p2p_acknowledgement_negative_bytes_processed(self):
        ...
        """
        ack = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.P2P_ACK,
                                          p2pAckData=xrd_pb2.P2PAcknowledgement(bytes_processed=20))
        channel = make_channel()
    ...
    @patch('xrd.core.p2p.p2pprotocol.P2PProtocol.peer')
    @patch('xrd.core.p2p.p2pprotocol.P2PProtocol.send')
