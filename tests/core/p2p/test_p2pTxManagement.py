...
class TestP2PTxManagement(TestCase):
    ...
    def test_notification(self):
        ...
        event = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.TX,
                                            txData=tx.pbdata)
    ...
    @patch('xrd.core.p2p.p2pTxManagement.logger')
...
class TestP2PTxManagementHandlers(TestCase):
    ...
    def test_handle_message_received(self):
        ...
        :return:
        """
        mrData = xrdlegacy_pb2.MRData(type=xrdlegacy_pb2.LegacyMessage.SL)
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_ignores_unknown_message_types(self):
        mrData = xrdlegacy_pb2.MRData(type=999)
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_transactions_ignored_while_unsynced(self):
        ...
        mrData = xrdlegacy_pb2.MRData(type=xrdlegacy_pb2.LegacyMessage.TX)
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_ignores_blocks(self):
        ...
        mrData = xrdlegacy_pb2.MRData(type=xrdlegacy_pb2.LegacyMessage.BK,
    ...
    @patch('xrd.core.p2p.p2pTxManagement.Transaction')
    def test_handle_message_transaction(self, m_Transaction):
        ...
        mtData = xrd_pb2.Transaction()
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.MT, mtData=mtData)
...
class TestP2PTxManagementSimpleHandlers(TestCase):
    ...
    def test_handle_token_transaction(self, m_Transaction, m_logger):
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.TK, tkData=xrd_pb2.Transaction())
    ...
    def test_handle_transfer_token_transaction(self, m_Transaction, m_logger):
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.TT, ttData=xrd_pb2.Transaction())
    ...
    def test_handle_lattice(self, m_Transaction, m_logger):
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.LT, ltData=xrd_pb2.Transaction())
    ...
    def test_handle_slave(self, m_Transaction, m_logger):
        msg = make_message(func_name=xrdlegacy_pb2.LegacyMessage.SL, slData=xrd_pb2.Transaction())
