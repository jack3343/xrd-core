...
from xrd.generated.xrd_pb2 import TokenBalance
...
class TestTransferTokenTransactionStateChanges(TestCase):
    ...
    def test_apply_transfer_token_txn_multi_send(self):
        """
        Alice has 1000 tokens and 100 xrd, Bob and Slave have none. Alice sends some tokens to Bob and Slave.
        """
    ...
    def test_apply_transfer_token_txn_send_tokens_to_self(self):
        """
        Alice has 1000 tokens and 100 xrd. She sends some tokens to herself. What happens next?
        """
