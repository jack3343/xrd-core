...
_TRANSACTIONMETADATA = _descriptor.Descriptor(
  ...
  full_name='xrd.TransactionMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='transaction', full_name='xrd.TransactionMetadata.transaction', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='block_number', full_name='xrd.TransactionMetadata.block_number', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='xrd.TransactionMetadata.timestamp', index=2,
...
_LASTTRANSACTIONS = _descriptor.Descriptor(
  ...
  full_name='xrd.LastTransactions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tx_metadata', full_name='xrd.LastTransactions.tx_metadata', index=0,
...
_FORKSTATE = _descriptor.Descriptor(
  name='ForkState',
  full_name='xrd.ForkState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initiator_headerhash', full_name='xrd.ForkState.initiator_headerhash', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fork_point_headerhash', full_name='xrd.ForkState.fork_point_headerhash', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='old_mainchain_hash_path', full_name='xrd.ForkState.old_mainchain_hash_path', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='new_mainchain_hash_path', full_name='xrd.ForkState.new_mainchain_hash_path', index=3,
...
_TRANSACTIONMETADATA.fields_by_name['transaction'].message_type = xrd__pb2._TRANSACTION
...
TransactionMetadata = _reflection.GeneratedProtocolMessageType('TransactionMetadata', (_message.Message,), dict(
  ...
  __module__ = 'xrdstateinfo_pb2'
  # @@protoc_insertion_point(class_scope:xrd.TransactionMetadata)
  ))
...
LastTransactions = _reflection.GeneratedProtocolMessageType('LastTransactions', (_message.Message,), dict(
  ...
  __module__ = 'xrdstateinfo_pb2'
  # @@protoc_insertion_point(class_scope:xrd.LastTransactions)
  ))
...
ForkState = _reflection.GeneratedProtocolMessageType('ForkState', (_message.Message,), dict(
  ...
  __module__ = 'xrdstateinfo_pb2'
  # @@protoc_insertion_point(class_scope:xrd.ForkState)
  ))
