...
from xrd.core.misc import ntp, logger, set_logger
from xrd.core.xrdnode import xrdNode
from xrd.services.services import start_services
...
def parse_arguments():
    ...
    parser.add_argument('--miningAddress', dest='mining_address', required=False,
                        help="xrd Wallet address on which mining reward has to be credited.")
