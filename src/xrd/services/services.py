...
from xrd.generated.xrd_pb2_grpc import add_PublicAPIServicer_to_server, add_AdminAPIServicer_to_server
from xrd.generated.xrdmining_pb2_grpc import add_MiningAPIServicer_to_server
from xrd.generated.xrdbase_pb2_grpc import add_BaseServicer_to_server
from xrd.generated.xrddebug_pb2_grpc import add_DebugAPIServicer_to_server
from xrd.services.BaseService import BaseService
from xrd.services.AdminAPIService import AdminAPIService
from xrd.services.PublicAPIService import PublicAPIService
from xrd.services.MiningAPIService import MiningAPIService
from xrd.services.DebugAPIService import DebugAPIService


def start_services(node: xrdNode):
