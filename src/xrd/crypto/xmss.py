...
from pyxrdlib import pyxrdlib
from pyxrdlib.pyxrdlib import bin2hstr, getRandomSeed, str2bin, bin2mnemonic, mnemonic2bin  # noqa
from pyxrdlib.pyxrdlib import XmssFast, xrdDescriptor

hash_functions = {
    "shake128": pyxrdlib.SHAKE_128,
    "shake256": pyxrdlib.SHAKE_256,
    "sha2_256": pyxrdlib.SHA2_256
}
...
class XMSS(object):
    ...
    def __init__(self, _xmssfast):
        ...
        >>> from xrd.crypto.doctest_data import *
