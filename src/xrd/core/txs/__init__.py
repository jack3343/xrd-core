...
TYPENAME_PACKAGE = {
    'transfer': 'xrd.core.txs',
    'coinbase': 'xrd.core.txs',
    'latticePK': 'xrd.core.txs',
    'message': 'xrd.core.txs',
    'token': 'xrd.core.txs',
    'transfer_token': 'xrd.core.txs',
    'slave': 'xrd.core.txs',

    'multi_sig_create': 'xrd.core.txs.multisig',
    'multi_sig_spend': 'xrd.core.txs.multisig',
    'multi_sig_vote': 'xrd.core.txs.multisig',

    'proposal_vote': 'xrd.core.txs.proposal',
}
