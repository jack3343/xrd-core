...
from pyxrdlib.pyxrdlib import xrdHelper, hstr2bin, sha2_256
...
class MultiSigAddressState(object):
    def __init__(self, protobuf_block=None):
        ...
        if protobuf_block is None:
            self._data = xrd_pb2.MultiSigAddressState()
    ...
    def pbdata(self):
        ...
        :rtype: xrd_pb2.MultiSigAddressState
        """
        return self._data
    ...
    def get_multi_sig_address_state(state: State,
        ...
        try:
            ...
            pbdata = xrd_pb2.MultiSigAddressState()
