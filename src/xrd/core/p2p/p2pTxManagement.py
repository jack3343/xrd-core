...
from xrd.core.txs.Transaction import Transaction
from xrd.core.messagereceipt import MessageReceipt
from xrd.core.misc import logger, ntp
from xrd.core.p2p.p2pObserver import P2PBaseObserver
...
class P2PTxManagement(P2PBaseObserver):
    ...
    def new_channel(self, channel):
        channel.register(xrdlegacy_pb2.LegacyMessage.MR, self.handle_message_received)
        channel.register(xrdlegacy_pb2.LegacyMessage.SFM, self.handle_full_message_request)

        channel.register(xrdlegacy_pb2.LegacyMessage.TX, self.handle_tx)
        channel.register(xrdlegacy_pb2.LegacyMessage.TK, self.handle_token_transaction)
        channel.register(xrdlegacy_pb2.LegacyMessage.TT, self.handle_transfer_token_transaction)
        channel.register(xrdlegacy_pb2.LegacyMessage.MT, self.handle_message_transaction)
        channel.register(xrdlegacy_pb2.LegacyMessage.LT, self.handle_lattice)
        channel.register(xrdlegacy_pb2.LegacyMessage.SL, self.handle_slave)
        channel.register(xrdlegacy_pb2.LegacyMessage.MC, self.handle_multi_sig_create)
        channel.register(xrdlegacy_pb2.LegacyMessage.MS, self.handle_multi_sig_spend)
        channel.register(xrdlegacy_pb2.LegacyMessage.MV, self.handle_multi_sig_vote)
    ...
    @staticmethod
    def handle_full_message_request(source, message: xrdlegacy_pb2.LegacyMessage):
        """
        Send Full Message
    ...
    def handle_tx(source, message: xrdlegacy_pb2.LegacyMessage):
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.TX)
        try:
    ...
    @staticmethod
    def handle_message_transaction(source, message: xrdlegacy_pb2.LegacyMessage):
        """
        Message Transaction
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.MT)
        try:
    ...
    def handle_token_transaction(source, message: xrdlegacy_pb2.LegacyMessage):
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.TK)
        try:
    ...
    @staticmethod
    def handle_transfer_token_transaction(source, message: xrdlegacy_pb2.LegacyMessage):
        """
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.TT)
        try:
    ...
    def handle_lattice(source, message: xrdlegacy_pb2.LegacyMessage):
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.LT)
        try:
    ...
    @staticmethod
    def handle_slave(source, message: xrdlegacy_pb2.LegacyMessage):
        """
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.SL)
        try:
    ...
    @staticmethod
    def handle_multi_sig_create(source, message: xrdlegacy_pb2.LegacyMessage):
        """
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.MC)
        try:
    ...
    @staticmethod
    def handle_multi_sig_spend(source, message: xrdlegacy_pb2.LegacyMessage):
        """
        Handles Multi Sig Transaction
        :param source:
        :param message:
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.MS)
        try:
    ...
    def handle_multi_sig_vote(source, message: xrdlegacy_pb2.LegacyMessage):
        ...
        :return:
        """
        P2PBaseObserver._validate_message(message, xrdlegacy_pb2.LegacyMessage.MV)
        try:
