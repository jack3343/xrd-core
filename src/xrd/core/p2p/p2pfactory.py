...
from xrd.core.misc import ntp, logger
from xrd.core.node import SyncState
from xrd.core.p2p.p2pprotocol import P2PProtocol
from xrd.core.p2p.IPMetadata import IPMetadata
from xrd.core.processors.TxnProcessor import TxnProcessor
from xrd.core.txs.MessageTransaction import MessageTransaction
from xrd.core.txs.SlaveTransaction import SlaveTransaction
from xrd.core.txs.LatticeTransaction import LatticeTransaction
from xrd.core.txs.TokenTransaction import TokenTransaction
from xrd.core.txs.TransferTokenTransaction import TransferTokenTransaction
...
from xrd.generated import xrdlegacy_pb2, xrd_pb2

p2p_msg_priority = {
            xrdlegacy_pb2.LegacyMessage.VE: 0,
            xrdlegacy_pb2.LegacyMessage.PL: 0,
            xrdlegacy_pb2.LegacyMessage.PONG: 0,

            ######################
            xrdlegacy_pb2.LegacyMessage.MR: 2,
            xrdlegacy_pb2.LegacyMessage.SFM: 1,

            xrdlegacy_pb2.LegacyMessage.BK: 1,
            xrdlegacy_pb2.LegacyMessage.FB: 0,
            xrdlegacy_pb2.LegacyMessage.PB: 0,
            xrdlegacy_pb2.LegacyMessage.BH: 1,

            ############################
            xrdlegacy_pb2.LegacyMessage.TX: 1,
            xrdlegacy_pb2.LegacyMessage.MT: 1,
            xrdlegacy_pb2.LegacyMessage.TK: 1,
            xrdlegacy_pb2.LegacyMessage.TT: 1,
            xrdlegacy_pb2.LegacyMessage.LT: 1,
            xrdlegacy_pb2.LegacyMessage.SL: 1,

            xrdlegacy_pb2.LegacyMessage.EPH: 3,

            xrdlegacy_pb2.LegacyMessage.SYNC: 0,
            xrdlegacy_pb2.LegacyMessage.CHAINSTATE: 0,
            xrdlegacy_pb2.LegacyMessage.HEADERHASHES: 1,
            xrdlegacy_pb2.LegacyMessage.P2P_ACK: 0,

            xrdlegacy_pb2.LegacyMessage.MC: 1,
            xrdlegacy_pb2.LegacyMessage.MS: 1,
            xrdlegacy_pb2.LegacyMessage.MV: 1,
        }
...
class P2PFactory(ServerFactory):
    ...
    def request_peer_blockheight(self):
        for peer in self._peer_connections:
            msg = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.BH,
                                              bhData=xrd_pb2.BlockHeightData(block_number=0))
            peer.send(msg)
    ...
    def peer_fetch_block(self, retry=0):
        ...
        if retry >= 1:
            ...
            self._xrd_node.peer_manager.ban_channel(self._target_channel)
    ...
    def compare_and_sync(self, source_peer, node_header_hash: xrd_pb2.NodeHeaderHash):
    ...
    def request_full_message(self, mr_data: xrdlegacy_pb2.MRData):
        ...
        for peer in peers_list:
            ...
            msg = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.SFM,
                                              mrData=xrdlegacy_pb2.MRData(hash=mr_data.hash, type=mr_data.type))
    ...
    def broadcast_block(self, block: Block):
        ...
        self.register_and_broadcast(xrdlegacy_pb2.LegacyMessage.BK, block.headerhash, block.pbdata, data)
    ...
    def broadcast(self, msg_type, msg_hash: bytes, mr_data=None):
        ...
        data = xrdlegacy_pb2.LegacyMessage(func_name=xrdlegacy_pb2.LegacyMessage.MR,
                                           mrData=mr_data)
    ...
    def add_connection(self, conn_protocol) -> bool:
        ...
        if self._xrd_node.peer_manager.is_banned(conn_protocol.peer):
            return False
        ...
        if conn_protocol.peer.ip == conn_protocol.host.ip and conn_protocol.peer.port == config.user.p2p_public_port:
            peer_list = [p for p in self._xrd_node.peer_manager.known_peer_addresses if p != conn_protocol.peer.full_address]
            self._xrd_node.peer_manager.extend_known_peers(peer_list)
            return False
