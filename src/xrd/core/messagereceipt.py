...
from xrd.generated.xrdlegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        xrdlegacy_pb2.LegacyMessage.VE: 'veData',
        xrdlegacy_pb2.LegacyMessage.PL: 'plData',
        xrdlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        xrdlegacy_pb2.LegacyMessage.MR: 'mrData',
        xrdlegacy_pb2.LegacyMessage.SFM: 'mrData',

        xrdlegacy_pb2.LegacyMessage.BK: 'block',
        xrdlegacy_pb2.LegacyMessage.FB: 'fbData',
        xrdlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        xrdlegacy_pb2.LegacyMessage.TX: 'txData',
        xrdlegacy_pb2.LegacyMessage.MT: 'mtData',
        xrdlegacy_pb2.LegacyMessage.TK: 'tkData',
        xrdlegacy_pb2.LegacyMessage.TT: 'ttData',
        xrdlegacy_pb2.LegacyMessage.LT: 'ltData',
        xrdlegacy_pb2.LegacyMessage.SL: 'slData',

        xrdlegacy_pb2.LegacyMessage.EPH: 'ephData',

        xrdlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        xrdlegacy_pb2.LegacyMessage.MC: 'mcData',
        xrdlegacy_pb2.LegacyMessage.MS: 'msData',
        xrdlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[xrdlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = xrdlegacy_pb2.LegacyMessage(**{'func_name': msg_type,
