...
from pyxrdlib.pyxrdlib import shake128, bin2hstr

from xrd.core.config import DevConfig, user as user_config
from xrd.core.formulas import block_reward
...
class BlockHeader(object):
    def __init__(self, protobuf_blockheader=None):
        ...
        if protobuf_blockheader is None:
            self._data = xrd_pb2.BlockHeader()
